...
mp.events.add("loginHandler", (handle) => {
    switch(handle){
        ...
        case "takeninfo":
        {
            browser1.execute(`$(".taken").show(); $("#registerButton").show();`);
            break;
        }
        case "taken2info":
        {
            browser1.execute(`$(".taken2").show(); $("#registerButton").show();`);
            break;
        }
        case "taken3info":
        {
            browser1.execute(`$(".taken3").show(); $("#registerButton").show();`);
            break;
        }
        case "incorrectinfo":
        {
        ...
        case "incorrectinfo2":
        {
            browser1.execute(`$(".incorrect2-info").show(); $("#loginButton").show();`);
            break;
        }
        case "tooshortlogin":
        {
        ...
        case "m":
        {
            browser1.execute(`$(".cmail").show();  $("#registerButton").show();`);
            break;;
        }
        case "email":
        {
            browser1.execute(`$(".mail").show();  $("#registerButton").show();`);
            break;;
        }
        case "tlban":
        {
